...
class MarketDetailViewController_Archive: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
extension MarketDetailViewController_Archive: UIViewControllerTransitioningDelegate {
