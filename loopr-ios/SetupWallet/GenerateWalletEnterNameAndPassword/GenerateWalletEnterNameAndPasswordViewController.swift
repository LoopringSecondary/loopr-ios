...
class GenerateWalletEnterNameAndPasswordViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        walletPasswordTextField.font = FontConfigManager.shared.getDigitalFont(size: 19)
        ...
        walletRepeatPasswordTextField.font = FontConfigManager.shared.getDigitalFont(size: 19)
